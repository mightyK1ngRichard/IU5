...
CODE SEGMENT 'CODE'
; --------------------------------------
LABTITLE DB 'Laboratory work #7$'
HELP1 DB 'New line - enter$'
HELP2 DB 'Exit - *$'
ENTRMSGE DB 'Enter the digit: $'
...
INPUTBIN PROC
  ...
  CHECK:
	  ...
	  jne	NUMBER
	  mov	PRGRMFLAG , 1 ; Иначе установка флага выхода из программы возврат из процедуры
	  jmp	EXIT
  NUMBER:
  ; Проверка цифр
  ; Если ascii-код	введенного символа меньше '0'	или больше '9' то проверка больших букв
	  cmp al , '0'
	  jb BIGCHR
	  cmp al , '9'
	  ja BIGCHR
